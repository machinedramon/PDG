...
export default function Login({
  ...
  return (
    ...
    <div className="mx-auto  min-h-screen flex justify-center items-center bg-login-bg bg-cover bg-no-repeat transition-all duration-300 ease-out">
      <AnimatePresence mode="wait">
        <motion.div
          ...
          layout
          className="bg-pdgBlack-900 m-8 py-8 px-2 sm:px-4 md:px-8 sm:gap-8 max-w-[949px] w-[80%] md:w-full rounded-2xl justify-center flex flex-col md:flex-row transition-all duration-300 ease-out"
        >
          <div className='h-auto w-full flex flex-1 justify-center '>
            <Image src={LogoAnimated} alt="PDG" className="w-[70%] sm:w-full hover:scale-105 transition-all duration-300 ease-out" />
          </div>
            ...
            {loginOption ?
              <form className="animate-in flex-1 flex flex-col w-full justify-center gap-8 text-foreground">
                <div className='gap-4 flex flex-col'>
                  <h1 className='font-bold text-[1.75rem] md:text-4xl text-pdgWhite-50 text-center'>
                    Pronto para começar?
                  </h1>
                  <p className='font-normal text-base text-pdgWhite-50 text-center'>
                ...
                <div className='flex gap-4 items-center flex-col sm:flex-row'>
                  ...
                  <p className='text-base font-bold text-[#fff] hidden sm:flex'>ou</p>
              ...
              :
              <form noValidate className="animate-in flex-1 flex flex-col w-full justify-center gap-8 text-foreground">
                <div className='gap-4 flex flex-col'>
                  <h1 className='font-bold text-4xl text-pdgWhite-50 text-center'>
                    Esqueceu sua senha?
                  </h1>
                  <p className='font-normal text-base text-pdgWhite-50 text-center'>
                    Calma que a gente te ajuda a recuperar
                  </p>
                </div>
                <div className="flex flex-col gap-2">
                  <label className="text-normal text-base text-pdgWhite-50" htmlFor="email">
