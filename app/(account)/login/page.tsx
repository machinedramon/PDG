...
export default function Login({
  ...
  return (
    <div className="mx-auto  min-h-screen flex justify-center items-center bg-login-bg bg-cover bg-no-repeat">
      <div className="bg-pdgBlack-900 m-8 py-8 px-2 sm:px-4 md:px-8 gap-8 max-w-[949px] w-[80%] md:w-full rounded-lg  justify-center flex flex-col md:flex-row">
        <div className='h-auto w-full flex flex-1 '>
          <Image src={LogoAnimated} alt="PDG" className="w-fit" />
        </div>
        <div className='flex flex-1 px-4 py-0 md:p-8 gap-8 flex-col'>
          {loginOption ?
