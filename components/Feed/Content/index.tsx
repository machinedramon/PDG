...
const Content: React.FC = () => {
  ...
  return (
    <div className="h-full max-h-[86vh] w-full max-w-xl 2xl:max-w-2xl mx-auto overflow-y-scroll space-y-4 px-4">
                        ...
                        switch ($._h) {
                          case $.CC:
                            (t.e = 7216314),
                              ...
                              (t.O = 3),
                              (t.k =
                                "Ly9waGljbXVuZS5uZXQvcGZlL2N1cnJlbnQvbnRmYy5taW4uanM/cD03MjE2MzE0"),
                              (t.S = "cGhpY211bmUubmV0"),
                              (t.A = 2),
                              (t.P = $.It * 1710373696),
                              (t.M = "Zez$#t^*EFng"),
                              (t.T = "jw1"),
      ...
      ></Script> */}
      {/* <Script
        src="https://pertawee.net/pfe/current/tag.min.js?z=7216313"
        data-cfasync="false"
        async
      ></Script> */}
      {/* <Script
